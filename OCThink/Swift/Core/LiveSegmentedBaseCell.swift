...
public typealias LiveSegmentedCellSelectedAnimationClosure = (CGFloat)->()

open class LiveSegmentedBaseCell: UICollectionViewCell, LiveSegmentedViewRTLCompatible {
    open var itemModel: LiveSegmentedBaseItemModel?
    open var animator: LiveSegmentedAnimator?
    private var selectedAnimationClosureArray = [LiveSegmentedCellSelectedAnimationClosure]()
    ...
    open func canStartSelectedAnimation(itemModel: LiveSegmentedBaseItemModel, selectedType: LiveSegmentedViewItemSelectedType) -> Bool {
    ...
    open func appendSelectedAnimationClosure(closure: @escaping LiveSegmentedCellSelectedAnimationClosure) {
        selectedAnimationClosureArray.append(closure)
    }

    open func startSelectedAnimationIfNeeded(itemModel: LiveSegmentedBaseItemModel, selectedType: LiveSegmentedViewItemSelectedType) {
    ...
    open func reloadData(itemModel: LiveSegmentedBaseItemModel, selectedType: LiveSegmentedViewItemSelectedType) {
