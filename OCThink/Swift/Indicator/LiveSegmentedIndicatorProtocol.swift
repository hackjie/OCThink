//
//  LiveSegmentedIndicatorProtocol.swift
//  LiveSegmentedView
//
...
public protocol LiveSegmentedIndicatorProtocol {
    ...
    func refreshIndicatorState(model: LiveSegmentedIndicatorSelectedParams)
    ...
    /// param percent 过渡百分比
    /// - Parameter model: model description
    func contentScrollViewDidScroll(model: LiveSegmentedIndicatorTransitionParams)
    ...
    /// - Parameter model: model description
    func selectItem(model: LiveSegmentedIndicatorSelectedParams)
}
