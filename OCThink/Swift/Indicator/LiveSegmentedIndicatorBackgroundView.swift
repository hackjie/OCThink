//
//  LiveSegmentedIndicatorBackgroundView.swift
//  LiveSegmentedView
//
...
open class LiveSegmentedIndicatorBackgroundView: LiveSegmentedIndicatorBaseView {
    ...
    open override func contentScrollViewDidScroll(model: LiveSegmentedIndicatorTransitionParams) {
        ...
        let targetX = LiveSegmentedViewTool.interpolate(from: leftX, to: rightX, percent: CGFloat(percent))
        if indicatorWidth == LiveSegmentedViewAutomaticDimension {
            targetWidth = LiveSegmentedViewTool.interpolate(from: leftWidth, to: rightWidth, percent: CGFloat(percent))
        }
